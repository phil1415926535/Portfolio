...
intro_func()
{
    ...
    $mkstrs 93 0
    echo
    printf "%s\n"  "*** This script can download the full list of CVE Vulnerabilities from the website:       ***" "*** https://cve.mitre.org/data/downloads/                                                 ***" "*** Please ensure you have at least 600MB of space to run all the features of this script ***"
    $mkstrs 93 0.01
    echo
    echo -e $dim$grn
