...
echo "$password" | sha256sum > ./secretpw/secretpw2.txt
...
# Compares the HASH of 2 files - 1: storing hash or original pw and 2: the hash of the file with entered password
